...
import type { Codec, CodecClass } from '@polkadot/types-codec/types/codec.js';
import type { AnyTuple, LookupString } from '@polkadot/types-codec/types/helpers.js';
import type { ICompact, IEnum, IMap, IMethod, INumber, IOption, IResult, ISet, IStruct, ITuple, IU8a, IVec } from '@polkadot/types-codec/types/interfaces.js';
