import type { AnyNumber, CodecClass, Registry, UIntBitLength } from '@polkadot/types-codec/types/index.js';
import { AbstractInt } from '@polkadot/types-codec/abstract/Int.js';
/**
 * @name Int
 * @description
