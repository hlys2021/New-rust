import type { SignerPayloadRawBase } from '@polkadot/types/types/index.js';
import type { ApiOptions, ApiTypes, DecorateMethod, Signer } from '@polkadot/api/types/index.js';
import { Getters } from '@polkadot/api/base/Getters.js';
