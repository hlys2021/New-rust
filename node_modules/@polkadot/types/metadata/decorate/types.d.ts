import type { AnyTuple, Codec, Registry } from '@polkadot/types-codec/types/index.js';
import type { DispatchErrorModule, DispatchErrorModuleU8, DispatchErrorModuleU8a, ErrorMetadataLatest, EventMetadataLatest, PalletConstantMetadataLatest } from '@polkadot/types/interfaces/index.js';
import type { StorageEntry } from '@polkadot/types/primitive/types.js';
import type { CallFunction, IEvent, IEventLike } from '@polkadot/types/types/index.js';
